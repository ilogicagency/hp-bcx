...
ColorSelector.prototype =
{
	...
	init: function(gradient)
	{
		...
		this.gradientContainer.style.width = '463px';
		this.gradientContainer.style.height = '463px';
...
//		context.drawImage(this.hueSelector, 0, 0, this.luminositySelector.width, this.luminositySelector.height);
		...
		function update(x, y, began)
		{
			...
			var pickHue = 0;
			if (scope.areaDelta < 220) {
				pickHue = 1;
			} else if (scope.areaDelta > 221) {
				pickHue = 2;
			}
